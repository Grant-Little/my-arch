...
DESKTOP="mesa xorg lightdm lightdm-slick-greeter pipewire pipewire-alsa pipewire-jack pipewire-pulse qtile alsa-utils brightnessctl alacritty thunar thunar-archive-plugin thunar-media-tags-plugin thunar-volman xarchiver ristretto vlc brasero firefox qbittorent obs-studio mousepad gnome-multi-writer shutter xreader libreoffice-still hunspell-en_us hyphen-en lxappearance network-manager-applet nitrogen rofi picom pavucontrol breeze-gtk breeze-icons"
